...
public class BanalyserTest
{
    ...
    public void testEquals()
    {
        ...
        Banalyser exp3 = new Banalyser(music1, sample1, BanalyserState.STOPPED,
                AdGenerator.getInstance().generateBannerAd(music1));
        Banalyser exp4 = new Banalyser(video1, sample2, BanalyserState.STOPPED,
                AdGenerator.getInstance().generateBannerAd(video1));
